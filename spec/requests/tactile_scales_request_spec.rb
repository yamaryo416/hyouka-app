  ...
  describe "#new" do
    context "login as admin" do
      ...
      it "show own patient new tactile scale page" do
        get new_patient_tactile_scales_path admin_patient
        expect(response).to render_template :new
      end

      it "show other patient new tactile scale page" do
        get new_patient_tactile_scales_path therapist_patient
        expect(response).to render_template :new
      end
    end
    ...
    context "login as therapist" do
      ...
      it "redirect to root url when show other patient new tactile scale page" do
        get new_patient_tactile_scales_path admin_patient
        expect(response).to redirect_to root_url
      end
    end
    ...
    context "not login" do
      it "redirect to login path when get new tactile scale page" do
        get new_patient_tactile_scales_path admin_patient
        expect(response).to redirect_to new_therapist_session_path
      end
    end
  ...
  describe "#edit" do
    ...
    context "login as admin" do
      ...
      it "show edit page in own patient page" do
        get edit_patient_tactile_scales_path admin_patient
        expect(response).to render_template :edit
      end

      it "show edit page in other patient page" do
        get edit_patient_tactile_scales_path therapist_patient
        expect(response).to render_template :edit
      end
    end
  ...
  describe "#update" do
    ...
    context "login as admin" do
      ...
      it "is success to update own patient tactile" do
        patch patient_tactile_scales_path(admin_patient), params: {
          tactile_scale: tactile_scale_params,
        }
      ...
      it "is success to update other patient tactile" do
        patch patient_tactile_scales_path(therapist_patient), params: {
          tactile_scale: tactile_scale_params,
        }
  ...
  describe "#destroy" do
    ...
    context "login as admin" do
      ...
      it "is success to destor own patient tactile" do
        expect do
          delete patient_tactile_scales_path admin_patient
        end.to change(TactileScale, :count).by(-1)
      end

      it "is success to destor other patient tactile" do
        expect do
          delete patient_tactile_scales_path therapist_patient
        end.to change(TactileScale, :count).by(-1)
      end
