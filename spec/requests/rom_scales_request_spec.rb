  ...
  describe "#new" do
    context "login as admin" do
      ...
      it "show other patient new rom scale page" do
        get new_patient_rom_scales_path therapist_patient
        expect(response).to render_template :new
      end
    end
  ...
  describe "#edit" do
    ...
    context "login as admin" do
      ...
      it "show edit page in own patient page" do
        get edit_patient_rom_scales_path admin_patient
        expect(response).to render_template :edit
      end

      it "show edit page in other patient page" do
        get edit_patient_rom_scales_path therapist_patient
        expect(response).to render_template :edit
      end
    end
  ...
  describe "#update" do
    ...
    context "login as admin" do
      ...
      it "is success to update own patient rom" do
        patch patient_rom_scales_path(admin_patient), params: {
          rom_scale: rom_scale_params,
        }
      ...
      it "is success to update other patient rom" do
        patch patient_rom_scales_path(therapist_patient), params: {
          rom_scale: rom_scale_params,
        }
  ...
  describe "#destroy" do
    ...
    context "login as admin" do
      ...
      it "is success to destor own patient rom" do
        expect do
          delete patient_rom_scales_path admin_patient
        end.to change(RomScale, :count).by(-1)
      end

      it "is success to destor other patient rom" do
        expect do
          delete patient_rom_scales_path therapist_patient
        end.to change(RomScale, :count).by(-1)
      end
