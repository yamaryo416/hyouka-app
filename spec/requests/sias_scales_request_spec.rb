  ...
  describe "#edit" do
    ...
    context "login as admin" do
      ...
      it "show edit page in own patient page" do
        get edit_patient_sias_scales_path admin_patient
        expect(response).to render_template :edit
      end

      it "show edit page in other patient page" do
        get edit_patient_sias_scales_path therapist_patient
        expect(response).to render_template :edit
      end
    end
  ...
  describe "#update" do
    ...
    context "login as admin" do
      ...
      it "is success to update own patient sias" do
        patch patient_sias_scales_path(admin_patient), params: {
          sias_scale: sias_scale_params,
        }
      ...
      it "is success to update other patient sias" do
        patch patient_sias_scales_path(therapist_patient), params: {
          sias_scale: sias_scale_params,
        }
  ...
  describe "#destroy" do
    ...
    context "login as admin" do
      ...
      it "is success to destor own patient sias" do
        expect do
          delete patient_sias_scales_path admin_patient
        end.to change(SiasScale, :count).by(-1)
      end

      it "is success to destor other patient sias" do
        expect do
          delete patient_sias_scales_path therapist_patient
        end.to change(SiasScale, :count).by(-1)
      end
