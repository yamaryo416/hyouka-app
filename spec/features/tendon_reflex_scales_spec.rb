...
RSpec.feature "TendonReflexScales", type: :feature do
  ...
  scenario "create patient tendon reflex" do
    ...
    expect(page).to have_selector ".undefined-scale", text: "腱反射"
    expect(page).not_to have_selector ".defined-scale", text: "腱反射"
    click_on "腱反射"
    expect(page).to have_current_path new_patient_tendon_reflex_scale_path(first_patient)
  ...
  scenario "show patient tendon reflex" do
    ...
    expect(page).to have_selector ".defined-scale", text: "腱反射"
    expect(page).not_to have_selector ".undefined-scale", text: "腱反射"
    click_on "腱反射"
